...
def save_stats_to_file(stats, end=False):
    ...
    if params['VERBOSE']:
        filename = path.join(params['FILE_PATH'], "stats.csv")
...
def generate_folders_and_files():
    ...
    if params['EXPERIMENT_NAME']:
        ...
        path_1 = path.join(getcwd(), "..", "results/NEW")
        ...
        params['FILE_PATH'] = path.join(getcwd(), "..", "results/NEW")

    #params['FILE_PATH'] = path.join(params['FILE_PATH'],params['PATH'])
